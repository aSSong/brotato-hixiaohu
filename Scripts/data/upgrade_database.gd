...
static func initialize_upgrades() -> void:
	var cost_white: int = 5
	var cost_green: int = 10
	var cost_blue: int = 20
	var cost_purple: int = 40
	var cost_orange: int = 80
	...
	hp_max_upgrade.description = "增加10点最大生命值"
	hp_max_upgrade.attribute_changes = {
		"max_hp": {"op": "add", "value": 10}
	}
	hp_max_upgrade.quality = UpgradeData.Quality.GREEN
	hp_max_upgrade.set_base_attribute_cost()
	...
	move_speed_upgrade.quality = UpgradeData.Quality.WHITE
	move_speed_upgrade.set_base_attribute_cost()
	...
	damage_reduction.quality = UpgradeData.Quality.GREEN
	damage_reduction.set_base_attribute_cost()
	...
	luck.quality = UpgradeData.Quality.ORANGE
	luck.set_base_attribute_cost()
	upgrades["luck"] = luck
	...
	attack_speed.quality = UpgradeData.Quality.PURPLE
	attack_speed.set_base_attribute_cost()
	...
	melee_damage.quality = UpgradeData.Quality.BLUE
	melee_damage.set_base_attribute_cost()
	...
	melee_range.quality = UpgradeData.Quality.BLUE
	melee_range.set_base_attribute_cost()
	...
	melee_speed.quality = UpgradeData.Quality.BLUE
	melee_speed.set_base_attribute_cost()
	...
	melee_knockback.quality = UpgradeData.Quality.BLUE
	melee_knockback.set_base_attribute_cost()
	...
	ranged_damage.quality = UpgradeData.Quality.BLUE
	ranged_damage.set_base_attribute_cost()
	...
	ranged_range.quality = UpgradeData.Quality.BLUE
	ranged_range.set_base_attribute_cost()
	...
	ranged_speed.quality = UpgradeData.Quality.BLUE
	ranged_speed.set_base_attribute_cost()
	...
	magic_damage.quality = UpgradeData.Quality.BLUE
	magic_damage.set_base_attribute_cost()
	...
	magic_range.quality = UpgradeData.Quality.BLUE
	magic_range.set_base_attribute_cost()
	...
	magic_speed.quality = UpgradeData.Quality.BLUE
	magic_speed.set_base_attribute_cost()
	...
	magic_explosion.quality = UpgradeData.Quality.BLUE
	magic_explosion.set_base_attribute_cost()
	upgrades["magic_explosion"] = magic_explosion
	
	# 注意：每个升级的品质和价格已在上面单独设置
	# 不再统一设置，允许每个升级有不同的品质
